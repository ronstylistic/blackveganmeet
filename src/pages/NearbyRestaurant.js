...
export default class NearbyRestaurant extends Component {
    ...
    static navigationOptions = ({ navigation }) => ({
        header: (
            <CustomHeader navigation={navigation} headerTitle='Nearby Restaurants' />
        )
    });
    ...
    getData = () => {
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                const urlFirst = `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${latitude},${longitude}&radius=1000&type=restaurant&key=${API_KEY}`
